...
function FbLogin() {
    ...
    const handleDeleteClick = () => {
        alert('Account Integration Deleted');
    }
    ...
    if (isLoggedIn) {
        fbContent = (
            <div>
                ...
                <div><Button style={{ backgroundColor: "red", margin: "5px", width: "97%" }} variant="contained" onClick={handleDeleteClick}>Delete Integration</Button></div>
                <div><Button style={{ backgroundColor: "blue", margin: "5px", width: "97%" }} variant="contained" onClick={handleReplyClick}>Reply to Messages</Button></div>
            </div>
        );
    }
